...
<head>
    ...
    <link rel="stylesheet " href="../assets/css/nos_hotels/dubai.css ">
    <title>Dubai</title>
</head>
<body>
    <!-- hedear -->
<header>
    ...
    <nav class="navbar bg-transparent navbar-expand-lg navbar-light ">
        <div class="container-fluid">
            <a class="navbar-brand logo" href="index.html"><img src="../assets/Images/logo.png" alt="logo" width="80"></a>
...
<article>
    <div class="container-fluid ">
        <img class="image_dubai img-fluid" src="../assets/Images/dubai/hotel-desert-dubai.png" alt="image dubai">
        <div class="row ">
            <div class="notes">
