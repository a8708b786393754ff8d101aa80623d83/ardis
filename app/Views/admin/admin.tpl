{if isset($smarty.session.pseudo)}
	{if $smarty.session.pseudo === '4dm1n4rd1s' || $smarty.session.pseudo === 'lithium'}
		<!DOCTYPE html>
		<html lang="en">
			<head>
				<meta charset="UTF-8">
					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="side-menu-container">
							<ul class="nav navbar-nav">
								...
								{if $smarty.session.pseudo eq "4dm1n4rd1s" && $smarty.session.id eq '1'}
									<li><a href="{base_url('admin/users')}"> <span class="glyphicon glyphicon-cloud"></span>Gestion des utilisateur</a></li>
								{/if}
			
								<!-- Dropdown-->
								<li class="panel panel-default" id="dropdown">
									<a data-toggle="collapse" href="#dropdown-lvl1">
										<span class="glyphicon glyphicon-user"></span> Nos hotels <span class="caret"></span>
									</a>
